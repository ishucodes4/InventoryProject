...
public class ViewSoldProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_sold_products);
    ...
    class GetCities extends AsyncTask<Void, Void, ArrayList<String>>{
        ...
        protected ArrayList<String> doInBackground(Void... voids) {
            ...
            try {
                ...
                String queryCategory = String.format("select name,company from orders where sellerId = '%s'",getIntent().getStringExtra("userId"));
